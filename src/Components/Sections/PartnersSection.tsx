...
const PartnersSection: React.FC = () => {
    ...
    return (
        <section className="relative mx-auto mt-20  max-w-280 overflow-hidden rounded-[30px]">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-6 py-20 lg:px-8">
                ...
                <div className="relative">
                    <div className="flex gap-8 overflow-x-auto md:overflow-x-hidden pb-10 pr-10 max-md:scroll-smooth max-md:partners-scroll">
                        {partners.map((partner, index) => (
                            <motion.div
                                ...
                                className="group relative max-w-45 min-w-45 aspect-4/3
                                 cursor-pointer overflow-hidden rounded-3xl border border-white/20
                                  bg-white/10 backdrop-blur-xl shadow-xl transition-all duration-300
