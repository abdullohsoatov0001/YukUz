...
const PartnersSection: React.FC = () => {
    ...
    return (
        <section className="relative mx-auto mt-20 min-h-125 max-w-280 overflow-hidden rounded-[30px]">
            {/* background */}
            <div
                ...
                <div className="grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-5">
                    {partners.map((partner, index) => (
                        <motion.div
                            ...
                            className="group relative aspect-4/3 cursor-pointer overflow-hidden rounded-2xl border border-white/20 bg-white/10 backdrop-blur-md transition-all duration-300 hover:border-white/30 hover:bg-white/15"
                        >
